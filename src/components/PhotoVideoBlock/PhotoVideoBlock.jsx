  ...
  return (
    ...
    <div className="photo-video__block">
      <div className="photo-video__block__wrapp">
        <animated.div style={springOverlayVertical} className="photo-video__block__wrapp__before"></animated.div>
        <animated.div
      ...
      <animated.div
        style={animation}
        className="photo-video__block__desc"      
      >
        <animated.div style={springOverlayVertical} className="photo-video__block__desc__wrap" >
        <animated.div style={springOverlayBlockVertical} className="overlay-block" />
